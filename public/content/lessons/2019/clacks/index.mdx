...
So for example, to calculate only 20 digits of $\pi$, one block would have to be 100 billion billion billion billion times the mass of the other. If the small block was 1 kilogram, that means the big one would have a mass 10 times that of the supermassive black hole at the center of the milky way. Or andromada!
